...
```{r St Paul's Hospital exception groups}
# Check the St Paul's Hospital total number of exceptions by each exception group
...
```{r St Paul's Hospital other exception reason}
